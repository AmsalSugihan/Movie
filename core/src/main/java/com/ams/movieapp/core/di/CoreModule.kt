package com.ams.movieapp.core.di

import androidx.room.Room
import com.ams.movieapp.core.BuildConfig
import com.ams.movieapp.core.data.MovieRepository
import com.ams.movieapp.core.data.source.local.LocalDataSource
import com.ams.movieapp.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("amsal".toCharArray())
